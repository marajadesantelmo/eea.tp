...
Los gráficos de violín nos muestran que los modelos completos clasifican mejor a los casos. Sin embargo, vale la pena remarcar que el modelo parece clasificar menor a los no precarios que a los precarios, ya que entre estos últimos hay muchos casos a los que se les asigna una baja probabilidad de ser precarios cuando en realidad sí lo son.
